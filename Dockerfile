...
RUN sed -i -e 's/about_us_page_content =.*/about_us_page_content = Use the following logins: <ol><li>whiteteamuser:testpass<\/li><li>team1user1:testpass<\/li><li>team2user1:testpass<\/li><li>redteamuser:testpass<\/li><\/ol>/g' engine.conf
