...
from scoring_engine.models.welcome import get_default_welcome_config
...
class TestWelcome:
    ...
    def setup(self, test_client, db_session):
        ...
        self.default_config = get_default_welcome_config()
    ...
    def test_home(self):
        ...
        assert self.mock_obj.call_args == call(
            "welcome.html",
            welcome_config=self.default_config,
            use_legacy=False,
        )
