...
class TestWorker(object):
    ...
    def test_simple_run_one_job(self):
        ...
        assert updated_job.service_id == '12345'
    ...
    def test_simple_run_two_jobs_one_run(self):
        job_1 = Job(service_id="12345", command="echo 'HELLO'")
        job_2 = Job(service_id="12345", command="echo 'HI'")
        ...
        assert updated_job_1.service_id == '12345'
    ...
    def test_simple_run_two_jobs_two_runs(self):
        job_1 = Job(service_id="12345", command="echo 'HELLO'")
        job_2 = Job(service_id="54321", command="echo 'HI'")
        self.worker_queue.add_job(job_1)
        self.worker_queue.add_job(job_2)
        self.worker.run(2)
        updated_job_1 = self.finished_queue.get_job()
        ...
        assert updated_job_1.passed() is False
        assert updated_job_1.output == 'HELLO\n'
        assert updated_job_2.service_id == '54321'
    ...
    def test_simple_run_three_jobs_unlimited_runs(self):
        job_1 = Job(service_id="12345", command="echo 'HELLO'")
        job_2 = Job(service_id="12345", command="echo 'ABC'")
        job_3 = Job(service_id="54321", command="echo 'HI'")
        self.worker_queue.add_job(job_1)
        self.worker_queue.add_job(job_2)
