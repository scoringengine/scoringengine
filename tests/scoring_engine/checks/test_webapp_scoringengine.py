...
class TestWebappScoringengineCheck(CheckTest):
    ...
    cmd = "pytest --tb=line -s -q -rA --scheme=https --hostip=127.0.0.1 --hostport=1234 --basepath=/ --username=testuser --password=testpass /usr/local/scoring_engine/checks/bin/webapp_scoringengine_check.py"
