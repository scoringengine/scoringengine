...
class TestSMTPSCheck(CheckTest):
    ...
    cmd = "smtps_check 'testuser@emaildomain.com' 'passtest' 'testuser@emaildomain.com' 'tousr@someone.com' 'A scoring engine test subject!' 'Hello!, This is an email body' '127.0.0.1' 1234"
