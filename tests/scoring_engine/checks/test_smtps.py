...
class TestSMTPSCheck(CheckTest):
    ...
    cmd = CHECKS_BIN_PATH + "/smtps_check 'testuser@emaildomain.com' 'passtest' 'testuser@emaildomain.com' 'tousr@someone.com' 'A scoring engine test subject!' 'Hello!, This is an email body' '127.0.0.1' 1234"
