...
class TestService(UnitTest):
    def test_init_service(self):
        service = Service(
            name="Example Service", check_name="ICMP IPv4 Check", host="127.0.0.1"
        )
    ...
    def test_last_check_result_false(self):
        ...
        check_1 = Check(
            round=round_obj, service=service, result=True, output="Good output"
        )
    ...
    def test_accounts(self):
        ...
        account_2 = Account(
            username="testname123", password="testpass", service=service
        )
        self.session.add(account_2)
        account_3 = Account(
            username="testusername", password="testpass", service=service
        )
