        ...
        self.setup = {
            "teams": [
                ...
                },
                {
                    "name": "RedTeam",
                    "color": "Red",
                    "users": [{"username": "redteamuser", "password": "testpass"}],
                },
            ]
        }
...
class TestTeamsData(CompetitionDataTest):
    ...
    def test_team_duplicate_services_name(self):
        ...
        self.verify_error(
            "Each team's service must have a unique name, found duplicates in 'Test' for team 'Team1'"
        )
    ...
    def test_team_additional_service(self):
        ...
        self.setup["teams"].append(second_team)
        self.verify_error(
            "Service 'Service2' for Team 'Team 2' not defined in other teams"
        )
    ...
    def test_team_different_service_points(self):
        ...
        self.setup["teams"].append(second_team)
        self.verify_error(
            "Incorrect points for Service 'SSH' for Team 'Team 2'. Got: 5 Expected: 150"
        )
...
class TestUserData(CompetitionDataTest):
    ...
    def test_duplicate_users(self):
        self.setup["teams"][0]["users"].append(
            {"username": "team1user1", "password": "somepassword"}
        )
...
class TestEnvironmentData(CompetitionDataTest):
    ...
    def test_bad_matching_content_type(self):
        self.setup["teams"][0]["services"][0]["environments"][0][
            "matching_content"
        ] = []
        self.verify_error(
            "Team1 SSH environment 'matching_content' field must be a string"
        )
...
class TestPropertyData(CompetitionDataTest):
    ...
    def test_bad_name_type(self):
        self.setup["teams"][0]["services"][0]["environments"][0]["properties"][0][
            "name"
        ] = []
    ...
    def test_bad_name_value(self):
        ...
        self.verify_error(
            "Team1 SSH SSHCheck does not require the property 'someproperty'"
        )
