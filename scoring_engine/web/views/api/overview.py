    ...
    if len(blue_team_ids) > 0:
        ...
        for blue_team_id in blue_team_ids:
            ...
            service_ratios.append(
                ...
                '{0} <span class="glyphicon glyphicon-chevron-up" aria-hidden="true"></span> / {1} <span class="glyphicon glyphicon-chevron-down" aria-hidden="true"></span>'.format(num_up_services.get(blue_team_id, 0), num_down_services.get(blue_team_id, 0))  # TODO - I don't like shimming html into this
            )
