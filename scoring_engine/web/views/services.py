...
def home():
    ...
    return render_template(
        "services.html", team_name=current_user.team.name, team_id=current_user.team.id
    )
...
def service(id):
    ...
    modify_account_usernames_setting = Setting.get_setting(
        "blue_team_update_account_usernames"
    ).value
    modify_account_passwords_setting = Setting.get_setting(
