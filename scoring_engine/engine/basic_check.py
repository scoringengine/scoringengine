...
CHECKS_BIN_PATH = os.path.abspath(
    os.path.join(os.path.dirname(os.path.abspath(__file__)), "../checks/bin")
)
...
class BasicCheck(object):
    ...
    def set_properties(self):
        ...
        for required_property in self.required_properties:
            self.properties[required_property] = self.get_environment_property_by_name(
                required_property
            )
